      ...
      <article className={styles.article}>
        <div className={`glass ${styles.articleCard}`}>
          ...
          <div className={styles.body}>
            <p>Hey, I HAVE to congratulate you for finding this page. This is well… I&apos;ll go by the name Kaustubh, the date is 29/05/2026. I&apos;m 14 at the time and documenting my mental health.</p>
            <p>I can&apos;t afford to buy a domain and stuff so this is an introduction lol. Here&apos;s a runthrough of my life.</p>
            ...
            <p className={styles.aside}>Funny. We all have our moments of despair — it&apos;s just that mine never seems to end does it?</p>
            <p>Anyways, my grandparents want me out of the house. I&apos;ve got a shitty dad. I need someone to talk to but I don&apos;t have anyone and I can&apos;t put my personal phone number on this website or I&apos;ll get thousands of calls.</p>
            <p>Well I don&apos;t know how long I&apos;ll publish here — maybe I forget about this and stuff — but hey, if you find this: welcome to my fucked up life!</p>
          </div>
